...
class UNet(nn.Module):
    ...
    def forward(self, x, gammas, segmap):
        """
        ...
        for layer_num, module in enumerate(self.input_blocks):
            h = module(h, emb, segmap)
            hs.append(h)
        h = self.middle_block(h, emb, segmap)
