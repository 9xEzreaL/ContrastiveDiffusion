...
class UNet(nn.Module):
    ...
    def __init__(
        ...
        def create_encoder(ds, in_channel):
            ch = input_ch = int(channel_mults[0] * inner_channel)
            input_block_chans = [ch]
        ...
        self.input_blocks_x, ch_x, input_block_chans_x = create_encoder(ds, in_channel)
        self.input_blocks_y, ch_y, input_block_chans_y = create_encoder(ds, guided_img_channel)
